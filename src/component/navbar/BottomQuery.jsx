import { Card, List, ListItem, Badge, Collapse } from "@material-tailwind/react";
        ...
        <>
          ...
          <Collapse open={isOpen}>
            {isOpen && (
              <>
                <Card
                  className={`absolute w-[80vw] h-[80vh] end-[2rem] bottom-[5em] -right-[5rem] sm:-right-[5rem] bg-myP sm:w-[45rem] border border-txt text-txt grid ${
                    isOpen2 ? "grid-cols-2 sm:grid-cols-4" : "grid-cols-2"
                  }`}
                >
                  <List>
                  ...
                  <div
                    className={`col-span-2 w-full text-txt border-l border-l-txt  lg:border-l lg:border-l-txt overflow-scroll ${
                      isOpen2 ? "" : "hidden"
                    }`}
                  >
                    <List className="grid grid-cols-1 sm:grid-cols-3">
                      <div>
                        <List.Item className='text-2xl font-bold'>Nome</List.Item>
                        {searchResults != null &&
                      ...
                      <div>
                        <List.Item className='text-2xl font-bold'>Descrizione</List.Item>
                        {searchResults != null &&
                      ...
                      <div>
                        <List.Item className='text-2xl font-bold'>Storia</List.Item>
                        {searchResults != null &&
