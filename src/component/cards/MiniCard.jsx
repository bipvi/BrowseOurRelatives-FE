  ...
  return (
    <>
      ...
      <CardBody className="!py-4">
        <Typography variant="lead" className="font-normal text-bg">
          Because it&apos;s about motivating the doers. Because I&apos;m here to
          follow my dreams and inspire others. <code>...</code>
        </Typography>
      </CardBody>
      <CardFooter className="flex items-center justify-between">
        <div className="flex items-center -space-x-3">
        <Button variant="outlined" size="2xs" className="flex items-center gap-2 text-bg">
        Read More {'\u00A0'} 
        <svg
